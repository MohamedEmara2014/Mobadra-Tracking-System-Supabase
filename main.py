...
PROJECT_LOCATIONS = [
    ...
    "هليوبوليس الجديدة", "هليوبوليس الجديدة","النورث هاوس", "40", "العبور الجديدة", "42", "43", "بيت الوطن", "45"
]
...
def get_mapped_df_for_summary(df, sec_name):
    if sec_name == "الحسابات":
        ...
        m = {"col1": "ما تم انجازه", "col2": "المعوقات", "col3": "حالة المشروع", "comment": f"ملاحظات {sec_name}"}
...
if not st.session_state.auth:
    ...
    if st.session_state.role == "admin":
            ...
            for i, sec_name in enumerate(all_sections):
                with tabs[i]:
                    ...
                    if not sec_data.empty:
                        ...
                        else: m_dict, cols = {"col1": "ما تم انجازه", "col2": "المعوقات", "col3": "حالة المشروع", "comment": "ملاحظات القسم", "action_note": "توجيه الإدارة"}, ["المشروع", "الموقع", "ما تم انجازه", "المعوقات والمشاكل", "حالة المشروع", "ملاحظات القسم", "توجيه الإدارة"]
        ...
        if res.data:
            ...
            else: m_dict, cols = {"col1": "ما تم انجازه", "col2": "المعوقات", "col3": "حالة المشروع", "comment": "ملاحظات القسم", "action_note": "🚩 توجيه الإدارة"}, ["المشروع", "الموقع", "🚩 توجيه الإدارة", "ما تم انجازه", "المعوقات والمشاكل", "حالة المشروع", "ملاحظات القسم"]
