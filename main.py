...
if not st.session_state.auth:
            ...
            for i, sec_name in enumerate(all_sections):
                with tabs[i]:
                    ...
                    if not sec_data.empty:
                        ...
                        else: m_dict, cols = {"col1": "ما تم انجازه", "col2": "أخر بند تم عمل مستخلص له", "col3": "حالة المشروع", "comment": "ملاحظات القسم", "action_note": "توجيه الإدارة"}, ["المشروع", "الموقع", "ما تم انجازه", "المعوقات والمشاكل", "حالة المشروع", "ملاحظات القسم", "توجيه الإدارة"]
    ...
    # --- واجهة الموظفين والأقسام ---
        ...
        if res.data:
            ...
            else: m_dict, cols = {"col1": "ما تم انجازه", "col2": "أخر بند تم عمل مستخلص له", "col3": "حالة المشروع", "comment": "ملاحظات القسم", "action_note": "🚩 توجيه الإدارة"}, ["المشروع", "الموقع", "🚩 توجيه الإدارة", "ما تم انجازه", "المعوقات والمشاكل", "حالة المشروع", "ملاحظات القسم"]
