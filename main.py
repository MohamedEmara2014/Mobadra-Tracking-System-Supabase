...
if not st.session_state.auth:
    ...
    # --- خيارات الجدول الزمني مع الرموز ---
    TIME_STATUS_OPTIONS = {
        "متوافق": "✅ متوافق",
        "متقدم": "🚀 متقدم",
        "متأخر": "⚠️ متأخر"
                    ...
                    if not sec_data.empty:
                        ...
                        st.data_editor(
                            ...
                            column_config={
                                ...
                                "الجدول الزمني": st.column_config.TextColumn(disabled=True),
        ...
        if res.data:
            ...
            edited_staff = st.data_editor(
                ...
                column_config={
                    ...
                    "الجدول الزمني": st.column_config.SelectboxColumn(
                        "الحالة الزمنية", 
                        options=list(TIME_STATUS_OPTIONS.values()), # عرض القائمة بالرموز
                        required=True
